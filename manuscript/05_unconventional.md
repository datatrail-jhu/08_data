...
![Unstructured data types](images/05_unconventional/05_data_unconventional-1.png)
...
![Sentiment analysis](images/05_unconventional/05_data_unconventional-2.png)
...
![Analysis of tweets in R](images/05_unconventional/05_data_unconventional-3.png)
...
![JSON data contain key-pairs](images/05_unconventional/05_data_unconventional-4.png)
...
![JSON data are hierarchical and nested](images/05_unconventional/05_data_unconventional-5.png)
...
![XML format relies on nodes, tags, and elements](images/05_unconventional/05_data_unconventional-7.png)
...
![`rvest` and `xml2` are helpful for web scraping and working with XML data](images/05_unconventional/05_data_unconventional-8.png)
...
![Google Maps street view](images/05_unconventional/05_data_unconventional-9.png)
...
![Data used from Google Maps street view to predict demographics of a neighborhood](images/05_unconventional/05_data_unconventional-10.png)
...
![Cars in a neighborhood can predict how the area votes](images/05_unconventional/05_data_unconventional-11.png)
