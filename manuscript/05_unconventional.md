...
![Unstructured data types](images/06_unconventional/06_data_unconventional-1.png)
...
![Sentiment analysis](images/06_unconventional/06_data_unconventional-2.png)
...
![Analysis of tweets in R](images/06_unconventional/06_data_unconventional-3.png)
...
![JSON data contain key-pairs](images/06_unconventional/06_data_unconventional-4.png)
...
![JSON data are hierarchical and nested](images/06_unconventional/06_data_unconventional-5.png)
...
![Wrangling Yelp data from JSON into tidy tabular data](images/06_unconventional/06_data_unconventional-6.png)
...
![XML format relies on nodes, tags, and elements](images/06_unconventional/06_data_unconventional-7.png)
...
![`rvest` and `xml2` are helpful for web scraping and working with XML data](images/06_unconventional/06_data_unconventional-8.png)
...
![Google Maps street view](images/06_unconventional/06_data_unconventional-9.png)
...
![Data used from Google Maps street view to predict demographics of a neighborhood](images/06_unconventional/06_data_unconventional-10.png)
...
![Cars in a neighborhood can predict how the area votes](images/06_unconventional/06_data_unconventional-11.png)
...
![`magick` package's example of adding an image to a plot](![Google Maps street view](images/06_unconventional/06_data_unconventional-12.png)
)
...
![clustering music in R](![Google Maps street view](images/06_unconventional/06_data_unconventional-14.png)
)
...
* ["Google Street View Can Reveal How Your Neighborhood Votes"](https://www.citylab.com/transportation/2017/12/google-street-view-data-demographics-cars-research/547436/); [Original Publicaton](http://www.pnas.org/content/pnas/early/2017/11/27/1700035114.full.pdf?sid=fb6ef880-a27f-4280-a693-5c2ab16fe65d)
...
C) A Google Sheet containing data in a tidy format
...
{choose-answers: 4}
? If you had data comprised of nodes, tags, and elements, which R package would likely be most helpful to you?
